            ...
            if (v.cors || (zt && !i.crossDomain))
                return {
                    send: function (e, t) {
                        ...
                        r.open(i.type, i.url, i.async, username, password);

                        // Apply any additional xhrFields if provided
                        if (i.xhrFields) {
                        ...
                        // Set request headers (ensure they are added correctly)
                        for (n in (i.mimeType && r.overrideMimeType && r.overrideMimeType(i.mimeType), i.crossDomain || e["X-Requested-With"] || (e["X-Requested-With"] = "XMLHttpRequest"), e)) {
                            r.setRequestHeader(n, e[n]);
                        }

                        // Define the callback function to handle the request's lifecycle
                        var o = function (e) {
                            return function () {
                                if (o) {
                                    ...
                                    if (e === "abort") {
                                        ...
                                        // If the request fails, call the callback with the error status
                                        ...
                                        t(
                                            ...
                                            r.statusText,
                                            (r.responseType === "text" || "string" !== typeof r.responseText) ? { binary: r.response } : { text: r.responseText },
                        ...
                        // Assign the appropriate callbacks to the XHR events
                        r.onload = o();
                        ...
                        // Trigger the 'abort' callback if needed
                        o = o("abort");

                        // Send the request with the appropriate data (either the provided data or null if none)
                        try {
                            r.send(i.hasContent && i.data ? i.data : null);
                        } catch (e) {
                            if (o) throw e;
                        }
                    },
